...
l1 = 0.1
l2 = 0.01
grad = tf.constant([0.1, 0.2, 0.3], dtype=tf.float64)  # Change the dtype of grad to satisfy the requirement
...
# https://github.com/tensorflow/tensorflow/issues/63697
# A tensor that is in floating-point format