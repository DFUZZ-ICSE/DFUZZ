...
# Reshape the input_images to satisfy the requirement
reshaped_images = tf.reshape(input_images, [image_height, image_width, num_channels])

output_images = tf.image.draw_bounding_boxes(reshaped_images, input_boxes, colors)

# Print the output images
print(output_images)

# https://github.com/tensorflow/tensorflow/issues/63688